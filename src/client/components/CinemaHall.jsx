...
export default function CinemaHall({
  ...
  console.log("PROP zoomed:", zoomed, "isMobileOrTablet:", isMobileOrTablet);
  ...
  useEffect(() => {
    console.log("CinemaHall zoom state:", zoomed, "on mobile:", isMobileOrTablet);
  }, [zoomed, isMobileOrTablet]);
  ...
  return (
    <div className={`container py-3 bg-dark text-white cinema-hall-container ${zoomed && isMobileOrTablet ? 'zoomed' : ''
      }`}>
